...
python train.py --data Ocean_barrier.yaml --weights yolov5s.pt --img 640 --batch-size 8
python train.py --data Ocean_coast.yaml --weights yolov5n.pt --img 640 --batch-size 8
"""
